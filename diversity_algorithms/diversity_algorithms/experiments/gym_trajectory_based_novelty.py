...
from diversity_algorithms.algorithms.trajectory_based_novelty_search import set_creator


#creator.create("Strategy", list, typecode="d")

from diversity_algorithms.algorithms.trajectory_based_novelty_search import novelty_ea
