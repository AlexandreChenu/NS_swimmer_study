...
params={
	...
	"n_hidden": RunParam("t", 10, "neural network size"),
	"episode_length":RunParam("H", 100, "episode_length")
}
...
nnparams={"n_hidden_layers": 2, "n_neurons_per_hidden": params["n_hidden"].get_value()}
